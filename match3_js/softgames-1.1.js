...
var SG = {
	...
	trigger : function( data, callback ){
        console.log("window.softgames-trigger:"+window.softgames);
		/**
		...
		console.log("window.softgames:"+window.softgames);
		window.softgames.trigger(d, callback);
		**/
        console.log("window.softgames-trigger do nothing!");
		return true;
	},
    ...
    redirectToPortal:function(){
        ...
        SG.detectPortalUrl();
        window.location.href="http://2612.co/";
    },
    ...
    detectPortalUrl:function(){
        ...
        if(typeof url !== "string") url="http://2612.co/";
        else url="http://"+url;
